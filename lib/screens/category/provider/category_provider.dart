  ...
  addCategory() async {
    try {
      if (selectedImage == null) {
        SnackBarHelper.showErrorSnackBar('Image is required');
        return;
      }
      ...
      if (response.isOk) {
        ...
        // This handles cases where response.isOk is false (e.g., 404, 500 errors)
        SnackBarHelper.showErrorSnackBar(
            'Error: ${response.body?['message'] ?? response.statusText}');
      }
    } catch (e) {
      print(e);
      SnackBarHelper.showErrorSnackBar('An unexpected error occurred: $e');
      rethrow; // Keep this if you need the calling function to handle the error too
    }
  }
